...
**🛡️ LogShield 2.0**
Live Windows Event Log forensic pipeline — streaming HMAC-chained tamper-evidence, ML anomaly detection, and MITRE ATT&CK-mapped attack simulation with full chain-of-custody reporting.
`Python` `Streamlit` `IsolationForest` `HMAC`

</td>
<td width="50%">

**🎣 Digital Decoy**
LLM-powered phishing detector that reads intent and tone, not just keywords, to catch malicious messages.
`Python` `LLM/NLP`
...
**🕵️ TraceMe**
Simulates a 7-day OSINT profiling attack to visualize how exposed your digital footprint actually is.
`React.js` `D3.js`
...
**🔐 SecureShare**
Zero-trust encrypted file sharing for Android — client-side AES-256, revocable access, no trust in the server.
`Kotlin` `Firebase` `AES-256`
...
**🎭 AuthentIQ**
Fake-account classifier with transparent, rule-based scoring — no black-box verdicts.
`Python`

</td>
<td width="50%">

**💼 NostalgiaMenu** *(SkyForger Technologies)*
OCR + Claude API pipeline shipped to production during my SWE internship.
`Python` `OCR` `Claude API`
